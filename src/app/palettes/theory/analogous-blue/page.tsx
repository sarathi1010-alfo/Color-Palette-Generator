...
const palette = programmaticPalettes.find(p => p.slug === "analogous-blue");

if (!palette) {
  throw new Error("Palette analogous-blue not found in data");
}
...
export default function AnalogousBluePage() {
