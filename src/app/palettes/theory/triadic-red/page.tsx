...
const palette = programmaticPalettes.find(p => p.slug === "triadic-red");

if (!palette) {
  throw new Error("Palette triadic-red not found in data");
}
...
export default function TriadicRedPage() {
