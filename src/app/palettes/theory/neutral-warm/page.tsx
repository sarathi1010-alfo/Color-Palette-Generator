...
const palette = programmaticPalettes.find(p => p.slug === "neutral-warm");

if (!palette) {
  throw new Error("Palette neutral-warm not found in data");
}
...
export default function NeutralWarmPage() {
