...
const palette = programmaticPalettes.find(p => p.slug === "complementary-green");

if (!palette) {
  throw new Error("Palette complementary-green not found in data");
}
...
export default function ComplementaryGreenPage() {
