        ...
        <PageWrapper className="py-20 max-w-4xl">
          ...
          <article className="prose prose-invert prose-lg max-w-none space-y-12 text-text-secondary">
            <section className="space-y-6">
              ...
              <p>
                Color harmony is the art and science of combining colors in a way that is pleasing to the eye. It creates a sense of order and balance in visual experiences. Understanding these rules is a prerequisite for anyone learning how to <Link href="/blog/choose-ui-color-palette" className="text-primary hover:underline font-bold">choose a color palette for UI design</Link> that is both accessible and beautiful.
              </p>
            </section>
